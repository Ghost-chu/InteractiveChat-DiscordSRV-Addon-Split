...
public class ChatColorUtils {
    ...
    public static final Set<ChatColor> FORMATTING_CODES = Set.of(ChatColor.MAGIC, ChatColor.BOLD, ChatColor.ITALIC, ChatColor.UNDERLINE, ChatColor.STRIKETHROUGH);
    ...
    public static String translateAlternateColorCodes(char code, String text) {
        return translateAlternateColorCodes(code, text, false, com.loohp.interactivechat.InteractiveChat.rgbTags, com.loohp.interactivechat.InteractiveChat.additionalRGBFormats);
    }
