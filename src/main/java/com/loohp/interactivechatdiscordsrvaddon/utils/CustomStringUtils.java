...
public class CustomStringUtils {
    ...
    public static String escapeReplaceAllMetaCharacters(String inputString) {
        for (String replaceAllMetaCharacter : REPLACE_ALL_META_CHARACTERS) {
            if (inputString.contains(replaceAllMetaCharacter)) {
                inputString = inputString.replace(replaceAllMetaCharacter, "\\" + replaceAllMetaCharacter);
            }
        }
        return inputString;
    }
